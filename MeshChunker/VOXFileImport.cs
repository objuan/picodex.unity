...
namespace brickgame
{
	namespace Model
	{
		...
		{
#if UNITY_EDITOR
			[MenuItem("BrickGame/Load .vox file as Bricks")]
			public static void LoadVoxelFileAsBrick()
			{
			...
			public static int CalcFaceCountAsAllocate(Cubizer.Model.VOXModel model, Color32[] palette, ref Dictionary<string, int> entities)
			{
			...
			{
				var cruncher = Cubizer.Model.VOXPolygonCruncher.CalcVoxelCruncher(data, colors, Cubizer.Model.VOXCruncherMode.Greedy);
				...
				foreach (var entity in entities)
				{
					...
					{
						Cubizer.Model.VOXModel.CreateCubeMesh16x16(it, ref vertices, ref normals, ref uv, ref triangles, ref index, scale);
