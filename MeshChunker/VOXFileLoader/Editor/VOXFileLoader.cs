...
public class VOXFileLoader : EditorWindow
{
	...
	[MenuItem("BrickGame/Cubizer/Load .vox file as Bricks")]
	public static void LoadVoxelFileAsBrick()
	{
		...
		if (!String.IsNullOrEmpty(filepath))
		{
			...
			VoxFileImport.LoadVoxelFileAsMeshChunker(filepath);
		}
	}

	[MenuItem("BrickGame/Cubizer/Show VOXFileLoader Inspector")]
	public static void ShowWindow()
	{
		VOXFileLoader.CreateInstance<VOXFileLoader>().Show();
	}

	[MenuItem("BrickGame/Cubizer/Load .vox file as Prefab")]
	...
	[MenuItem("BrickGame/Cubizer/Load .vox file as GameObject")]
